    ...
    >
      <Container style={wrapper}>
        ...
        >
          ...
          <Col md={6}>
            <h2 style={{ color: "#f0c19e" }}>Code Websites From Anywhere instantly</h2>
            <h5
              style={{
                textAlign: "justify",
            ...
            >
              ...
              JavaScript code, and check the live preview of your sites instantly.
            </h5>
            ...
            <h2 style={{ color: "#f0c19e", paddingTop: "70px" }}>
              Generate your README file in Seconds
            </h2>
            <h5
              style={{
                textAlign: "justify",
